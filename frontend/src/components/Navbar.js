...
const Navbar = () => {
  ...
  return (
    <nav style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'14px 32px',background:'#b0b5b9',color:'#fff',boxShadow:'0 2px 8px rgba(0,0,0,0.15)',position:'sticky',top:0,zIndex:100}}>
