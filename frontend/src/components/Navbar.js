...
const Navbar = () => {
  ...
  return (
    <nav style={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'14px 32px',background:'#b0b5b9',color:'#4d4a4a',boxShadow:'0 2px 8px rgba(0,0,0,0.15)',position:'sticky',top:0,zIndex:100}}>
    <Link to="/menu" style={{fontSize:'22px',fontWeight:'bold',color:'#fff',textDecoration:'none'}}>🍕 FOOD   Delivery Application </Link>
